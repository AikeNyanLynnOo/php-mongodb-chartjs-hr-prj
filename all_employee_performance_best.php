...
function sortAllDescending($all_result0,$all_result1,$all_result2,$all_result3,$all_result4,$all_result5){
	$all_result=[];
...
//selected department
	...
	switch ($selectedvalue) {
		case 'All':
			$all_result_desc = sortAllDescending($all_result0,$all_result1,$all_result2,$all_result3,$all_result4,$all_result5);
			break;
		case 'Operations':
            $all_result_desc = sortAllDescending($op_result0,$op_result1,$op_result2,$op_result3,$op_result4,$op_result5);
		    break;
		case 'Sales':
            $all_result_desc = sortAllDescending($sales_result0,$sales_result1,$sales_result2,$sales_result3,$sales_result4,$sales_result5);
		    break;
		case 'Human Resources':
            $all_result_desc = sortAllDescending($hr_result0,$hr_result1,$hr_result2,$hr_result3,$hr_result4,$hr_result5);
		    break;
		case 'IT':
            $all_result_desc = sortAllDescending($it_result0,$it_result1,$it_result2,$it_result3,$it_result4,$it_result5);
		    break;
		case 'Warehouse':
            $all_result_desc = sortAllDescending($wh_result0,$wh_result1,$wh_result2,$wh_result3,$wh_result4,$wh_result5);
		    break;
		case 'Finance':
            $all_result_desc = sortAllDescending($fi_result0,$fi_result1,$fi_result2,$fi_result3,$fi_result4,$fi_result5);
		    break;                      
		default:
			$all_result_desc = sortAllDescending($all_result0,$all_result1,$all_result2,$all_result3,$all_result4,$all_result5);
			break;
               ...
               <div class="col-lg-12">
                 ...
                 <div class="hpanel">
                     ...
                     <div class="panel-heading" style="font-size:17px;">
                        <h4 style="margin-bottom:-30px;">Employees ordered by performance</h4>
                        
                        <form action="all_employee_performance_best.php" method="POST" id="my_form" style="margin-bottom:40px;">
