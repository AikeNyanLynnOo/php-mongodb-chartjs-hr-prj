...
// show performance by selected value
$bad_emp = 0;
$normal_emp = 0;
$good_emp = 0;
$very_good_emp = 0;
...
if ($selectedvalue == "All") {
  $bad_emp = getEmpPerformance("All","bad");
  $normal_emp = getEmpPerformance("All","normal");
  $good_emp = getEmpPerformance("All","good");
  $very_good_emp = getEmpPerformance("All","very good");
}elseif ($selectedvalue == "Operations") {
   $bad_emp = getEmpPerformance("Operations","bad");
  $normal_emp = getEmpPerformance("Operations","normal");
  $good_emp = getEmpPerformance("Operations","good");
  $very_good_emp = getEmpPerformance("Operations","very good");
}elseif ($selectedvalue == "Sales") {
   $bad_emp = getEmpPerformance("Sales","bad");
  $normal_emp = getEmpPerformance("Sales","normal");
  $good_emp = getEmpPerformance("Sales","good");
  $very_good_emp = getEmpPerformance("Sales","very good");
}elseif ($selectedvalue == "Human Resources") {
   $bad_emp = getEmpPerformance("Human Resources","bad");
  $normal_emp = getEmpPerformance("Human Resources","normal");
  $good_emp = getEmpPerformance("Human Resources","good");
  $very_good_emp = getEmpPerformance("Human Resources","very good");
}elseif ($selectedvalue == "IT") {
  $bad_emp = getEmpPerformance("IT","bad");
  $normal_emp = getEmpPerformance("IT","normal");
  $good_emp = getEmpPerformance("IT","good");
  $very_good_emp = getEmpPerformance("IT","very good");
}elseif ($selectedvalue == "Warehouse") {
   $bad_emp = getEmpPerformance("Warehouse","bad");
  $normal_emp = getEmpPerformance("Warehouse","normal");
  $good_emp = getEmpPerformance("Warehouse","good");
  $very_good_emp = getEmpPerformance("Warehouse","very good");
}elseif ($selectedvalue == "Finance") {
   $bad_emp = getEmpPerformance("Finance","bad");
  $normal_emp = getEmpPerformance("Finance","normal");
  $good_emp = getEmpPerformance("Finance","good");
  $very_good_emp = getEmpPerformance("Finance","very good");
}else{
    ...
    <aside id="menu">
        <div id="navigation" style="width:300px">
            <ul class="nav" id="side-menu">
              ...
              echo'
              <li style="border-bottom:1px solid #c97ce5;margin-top:9px;margin-bottom:4px;"></li>
              <li><a href="#row_1">Top Employees</a></li>
              <li><a href="#row_2">Employee percent by department</a></li>
         <li><a href="#row_2">Male/Female</a></li>
         <li><a href="#row_2">Salary/Budget</a></li>
         <li><a href="#row_3">Appoint & Dismissal</a></li>
         <li><a href="#row_3">Department performance</a></li>
         <li><a href="#row_4">Dismissal reasons</a></li>
         <li><a href="#row_4">Turnover reasons</a></li>
         <li><a href="#row_5">Employees performance</a></li>
         <li><a href="#row_6">Bad employees</a></li>
            </ul>
        </div>
    </aside>
    <div id="wrapper">
         ...
         <div class="content">
            ...
            <div class="row" id="row_5">
               <div class="col-lg-12">
                  <div class="hpanel">
                     <div class="panel-heading">
                        <p style="margin-bottom:-30px;">Performance Indicator</p>
                         <form action="index.php" method="POST" id="my_form" style="margin-bottom:40px;">
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  data: [{
    ...
    dataPoints: [
      { y: <?php echo $bad_emp;?>, name: "lack of effort" },
      { y: <?php echo $normal_emp;?>, name: "loose effort" },
      { y: <?php echo $good_emp;?>, name: "Dutiful" },
      { y: <?php echo $very_good_emp;?>, name: "Appreciable" }
    ]
  }]
});
chart.render();
