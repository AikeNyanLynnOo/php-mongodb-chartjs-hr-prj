                 ...
                 <div class="hpanel">
                  ...
                  <div class="panel-body no-padding">
                        <ul class="list-group" style="font-size:17px;">
                           ...
                           <li class="list-group-item">
                              <span class="badge badge-primary">'.showStar($_GET["Performance_rating"]).'</span>
                              Manager satisfaction
                           </li>
                           <li class="list-group-item">
                              <span class="badge badge-primary">'.showStar($_GET["Leader_review"]).'</span>
                              Leader review
                           </li>
                           <li class="list-group-item">
                              <span class="badge badge-primary">'.showStar($_GET["Member_review"]).'</span>
                              Member review
                           </li>
                           <li class="list-group-item">
                  ...
                  <div class="hpanel">
                     ...
                     <form action="php/update_employee_from_index.php" method="POST">
                        ...
                        <input type="hidden" value="'.$_GET["id"].'" id="id" class="form-control" name="id" required>
                              ...
                              <input type="hidden" value="'.$_GET["Leader_review"].'" id="performance_rating" class="form-control" name="Leader_review" required>

                              <input type="hidden" value="'.$_GET["Member_review"].'" id="performance_rating" class="form-control" name="Member_review" required>
                        ...
                        <div class="form-group col-lg-12">
                              ...
                              <input type="text" value="'.$_GET["Salary"].'" id="salary" class="form-control" name="Salary" '.showReadonly($first_part).'>
                              </div>
                           </div><br>
                        ...
                        <div class="form-group col-lg-12">
                              ...
                              <select name="salary_plus" style="width:100%;height: 35px"  required '.showDisabled($first_part).'>
                         ...
                         <div class="form-group col-lg-12" hidden>
                              ...
                              <input type="text" value="'.$_GET["Bonus"].'" id="bonus" class="form-control" name="Bonus" '.showReadonly($first_part).'>
                              </div>
                           </div><br>   
                          <div class="form-group col-lg-12">
                         ...
                         <div class="form-group col-lg-12">
                           ...
                           <div class="form-group col-lg-12">
                              <label><h4>Best employee</h4></label>
