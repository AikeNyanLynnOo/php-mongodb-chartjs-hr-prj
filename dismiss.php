      ...
      <div class="content" style="margin-left:300px;margin-right:300px;">
            <div class="row" style="margin-top:100px;">
               ...
               <div class="text-center m-b-md">
                  <h2>Employee Dismiss</h2>
               </div>
               <br>
               <div class="hpanel">
                  <div class="panel-body no-shadow th-border">
                     <form action="php/endjob_employee.php" id="loginForm" method="POST" style="font-size: 16px;">
                        <div class="row">
                           ...
                           <input type="hidden" value="'.$Retire_Date.'" id="retire_date" class="form-control" name="Retire_Date" required>
                           <input type="hidden" value="'.$Retire_Reason.'" id="retire_reason" class="form-control" name="Retire_Reason" required>
                           <div class="form-group col-lg-12">
                             ...
                             <div class="input-group m-b"><span class="input-group-addon"><img src="images/reason_field.png" alt="name" style="height:20px;width:20px;"></span>
                                <select name="Fire_Reason" style="width:100%;height: 35px"  required>
                                  <option value="Too many mistakes">Too many mistakes</option>
                                  <option value="Absent without excuse">Absent without excuse</option>
                                  <option value="Excuse many times">Excuse many times</option>
                                  <option value="Late many times">Late many times</option>
                        ...
                        <div class="form-group col-lg-12">
                              ...
                              <input type="date" value="" id="fire_date" class="form-control" name="Fire_Date"  style="padding-bottom:40px;" required/>
                              </div>
                           </div><br>
                        <br><br><br>
                        <div class="text-center">
                           ...
                           <input type="submit" name="submit" id="submit" value="Confirm" class="btn btn-primary" style="margin-top:20px;font-size:17px;margin-left:25px;" />
