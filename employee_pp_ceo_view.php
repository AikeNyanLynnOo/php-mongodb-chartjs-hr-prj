               ...
               <div class="col-lg-12">
                 <div class="hpanel">
                        <form action="php/update_photo.php" method="POST" enctype="multipart/form-data">
                          <div class="upload-btn-wrapper pull-right" style="display:none;">
                     ...
                     <form action="php/update_employee.php" id="loginForm" method="POST" style="font-size:17px;">
                        <div class="row">
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <input type="date" value="'.date('Y-m-d',strtotime($_GET["Age"])).'" id="age" class="form-control" name="Age" style="padding-bottom:40px;" required readonly>   
                              </div>
                           </div><br>
                           <div class="form-group col-lg-12">
                             ...
                             <div class="input-group m-b"><span class="input-group-addon"><img src="images/depart_field.png" alt="name" style="height:20px;width:20px;"></span>
                                <select name="Department" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                             ...
                             <div class="input-group m-b"><span class="input-group-addon"><img src="images/position_field.png" alt="name" style="height:20px;width:20px;"></span>
                                <select name="Position" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                               ...
                               <div class="input-group m-b"><span class="input-group-addon"><img src="images/edu_field.png" alt="name" style="height:20px;width:20px;"></span>
                                <select name="Education" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                             ...
                             <div class="input-group m-b"><span class="input-group-addon"><img src="images/marital_field.png" alt="name" style="height:20px;width:20px;"></span>
                              <select name="Marital_status" style="width:100%;height: 35px"  required disabled>
                            ...
                            <div class="form-group col-lg-12">
                              ...
                              <div class="input-group m-b"><span class="input-group-addon"><img src="images/race_field.png" alt="name" style="height:20px;width:20px;"></span>
                               <select name="Race" style="width:100%;height: 35px"  required disabled>
                            ...
                            <div class="form-group col-lg-12">
                              <label>Sex</label><br>
                               ...
                               <input type="radio" name="Sex" value="Female" style="margin-left:30px;" '.value_checked("Female").' required readonly> Female
                           </div><br>
                           <div class="form-group col-lg-12">
                              <label>Mail</label>
                              ...
                              <input type="text" value="'.$_GET["Mail"].'" id="mail" class="form-control" name="Mail" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}" style="font-size:17px;" readonly/>
                              </div>
                           </div><br>
                           <div class="form-group col-lg-12">
                              <label>Address</label>
                              ...
                              <input type="text" value="'.$_GET["Address"].'" id="address" class="form-control" name="Address" required style="font-size:17px;" readonly/>
                              </div>
                           </div><br>
                            <div class="form-group col-lg-12">
                              ...
                              <input type="text" value="'.$_GET["Hours_Per_Week"].'" id="hours_per_week" class="form-control" name="Hours_Per_Week" required readonly/>
                              </div>
                           </div><br>
                            <div class="form-group col-lg-12">
                              ...
                              <select id="Native_Country" name="Native_Country" style="width:100%;height: 35px"  required disabled>
                            ...
                            <div class="form-group col-lg-12">
                              ...
                              <input type="text" value="'.$_GET["Salary"].'" id="salary" class="form-control" name="Salary" required readonly/>
                              </div>
                           </div><br>
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <input type="date" value="'.date('Y-m-d',strtotime($_GET["Start_Date"])).'" id="start_date" class="form-control" name="Start_Date" required style="padding-bottom:40px;" readonly/>
                              </div>
                           </div><br>
                            <div class="form-group col-lg-12">
                              ...
                              <select name="Performance_rating" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <div class="input-group m-b"><span class="input-group-addon"><img src="images/performance_field.png" alt="name" style="height:20px;width:20px;"></span>
                              <select name="Leader_review" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <div class="input-group m-b"><span class="input-group-addon"><img src="images/performance_field.png" alt="name" style="height:20px;width:20px;"></span>
                              <select name="Member_review" style="width:100%;height: 35px"  required disabled>
                            ...
                            <div class="form-group col-lg-12">
                              ...
                              <select name="Late_times" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <select name="Excuse_times" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <select name="Absent_W_Excuse" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <select name="Mistakes" style="width:100%;height: 35px"  required disabled>
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <input type="text" value="'.$_GET["Bonus"].'" id="bonus" class="form-control" name="Bonus" required readonly/>
                              </div>
                           </div><br>
