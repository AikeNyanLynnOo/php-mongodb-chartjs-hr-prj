            ...
            <div class="row" style="margin-top:30px;">
               <div class="col-lg-12">
                 ...
                 <form action="php/upload_photo_admin.php" method="POST" enctype="multipart/form-data">
                          ...
                          <input type="hidden" value="'.$_GET["username"].'" id="username" class="form-control" style="font-size:17px;" name="username" required>
                  ...
                  <div class="panel-body no-shadow th-border">
                     <form action="php/update_admin.php" id="loginForm" method="POST" style="font-size:17px;">
                        <div class="row">
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <input id="password_field" type="password" value="'.base64_decode($_GET["password"]).'" id="password" class="form-control" name="password" required pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$" style="font-size:17px;">
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <div class="input-group m-b"><span class="input-group-addon"><img src="images/position_field.png" alt="name" style="height:20px;width:20px;"></span>
                                <select name="position" style="width:100%;height: 35px" style="font-size:17px;"  required>';
                                  if (checkAdminExist("CEO")==0 or $_SESSION["position"]=="CEO") {
                                  ...
                                  ?>
                                  <?php 
                                  if (checkAdminExist("GENERAL_MANAGER")==0 or $_SESSION["position"]=="GENERAL_MANAGER") {
                                  ...
                                  <?php 
                                  if (checkAdminExist("OPERATION_MANAGER")==0 or $_SESSION["position"]=="OPERATION_MANAGER") {
                                  ...
                                  ?>
                                  <?php 
                                  if (checkAdminExist("SALES_MANAGER")==0 or $_SESSION["position"]=="SALES_MANAGER") {
                                  ...
                                  ?>
                                  <?php 
                                  if (checkAdminExist("HR_MANAGER")==0 or $_SESSION["position"]=="HR_MANAGER") {
                                  ...
                                  ?>
                                  <?php 
                                  if (checkAdminExist("IT_MANAGER")==0 or $_SESSION["position"]=="IT_MANAGER") {
                                  ...
                                  ?>
                                  <?php 
                                  if (checkAdminExist("WAREHOUSE_MANAGER")==0 or $_SESSION["position"]=="WAREHOUSE_MANAGER") {
                                  ...
                                  ?>
                                  <?php 
                                  if (checkAdminExist("FINANCE_MANAGER")==0 or $_SESSION["position"]=="FINANCE_MANAGER") {
                        ...
                        <div class="text-center">
                           <input type="submit" name="submit" id="submit" value="Update" class="btn btn-primary text-center" style="margin-right:25px;"/>     |      
                           <a href="retire_admin.php?id='.$_GET["id"]."&Name=".$_GET["username"].'"class="btn btn-primary" style="background-color:red;margin-left:25px;">Leave job</a>
                        </div>
