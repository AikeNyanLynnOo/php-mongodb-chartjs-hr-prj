...
function calculateSalary(){
	...
	$new_salary;
	$bonus = 0;
	if (isset($_POST["salary_minus"])) {
		$old_salary = (int)$_POST["Salary"];
		$new_salary = $old_salary - ((int)$_POST["salary_minus"]/100)*$old_salary;
	}
	if (isset($_POST["salary_plus"])) {
		$old_salary = (int)$_POST["Salary"];
		$new_salary = $old_salary + ((int)$_POST["salary_plus"]/100)*$old_salary;
