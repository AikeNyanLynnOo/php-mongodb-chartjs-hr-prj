                     ...
                     <form action="php/update_employee.php" id="loginForm" method="POST" style="font-size:17px;">
                        <div class="row">
                           ...
                           <div class="form-group col-lg-12">
                              ...
                              <input type="text" value="'.$_GET["Name"].'" id="name" class="form-control" name="Name" required>
                            </div>
                           </div><br>
                           <div class="form-group col-lg-12">
                           ...
                           <div class="form-group col-lg-12">
                            ...
                            <div class="form-group col-lg-12">
                              ...
                              <select name="Performance_rating" style="width:100%;height: 35px"  required>
                                  <option value="0" '.value_selected_performance(0).'>0</option>
                        ...
                        <div class="text-center">
                           ...
                           <input type="submit" name="submit" id="submit" value="Update" class="btn btn-primary text-center" style="margin-right:25px;margin-left:25px;font-size:17px;"/> |
